...
<head>
    ...
    <script>
        ...
        function output(res) {
            ...
            tag += '<th scope="col">사용 허가<br>신청</th>'
            tag += '</tr>'
            tag += '</thead>'
            tag += '<tbody>'
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="home">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="/cloud/member/goPatent">검색 분류 <i class="ion-ios-arrow-forward"></i></a></span> <span>특허 검색 <i class="ion-ios-arrow-forward"></i></span></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/cloud/member/permitForm" method="post" id="permitForm">
                        ...
                        <label for="item-option" class="text-black">제품 선택<label>
