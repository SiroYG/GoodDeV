      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="blog.html">특허 <i class="ion-ios-arrow-forward"></i></a></span> <span>특허 사용 신청 확인<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-10 heading-section text-center ftco-animate">
            ...
            <p>해당 특허에 대한 사용 신청서입니다.<br>
            사용 허가를 원하실 경우 사용 허가서를 첨부해주세요.<br>
    ...
    <div class="write_table">
        <form action="" method="POST" id="">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="" id="" placeholder="KR100000000">
                </div>
            </div>
            <div class="form-group row">
...
<br><br>
            <div class="form-group row">
                <div class="col-sm-10">
                    <a href="#" class="btns btn-3"><span class="white">&nbsp;&nbsp;수정하기&nbsp;&nbsp;</span></a> &nbsp;&nbsp; <a href="#" class="btns btn-3-red" style="margin-top: 0;"><span class="white">&nbsp;&nbsp;취소&nbsp;&nbsp;</span></a>
                </div>
