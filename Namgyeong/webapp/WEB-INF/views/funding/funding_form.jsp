        ...
        <form action="" method="post" id="" class="">
            <div class="write_table">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="fundingStartDate" id="" placeholder="2019 / 09 / 04 (목)" readonly="readonly">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" name="fundingDueDate" id="" placeholder="2019 / 09 / 16 (월)">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="" id="" placeholder="펀딩 타이틀">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label"><span><b>제품 정보</b></span></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="itemContent" id="" placeholder="아이템 정보 불러오는법....?">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="8" cols="112" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <a href="#" class="btnss btn-3"><span class="white">등록하기</span></a> 
                &nbsp;&nbsp; <a href="#" class="btnss btn-3-red"><span class="white">취소</span></a>
