					...
					<form method="POST">
						<div class="input-group">
							<input class="input--style-2" type="text"
								placeholder="${sessionScope.loginId}" name="id"
								readonly="readonly">
						</div>
						<div class="input-group">
						...
						<div class="input-group">
							<input class="input--style-2" type="password"
								placeholder="비밀번호 재입력" id="repw">
						</div>
						<div class="input-group">
							<input class="input--style-2" type="text"
								placeholder="이메일(abc123@def.com)" name="email">
						</div>
						<div class="input-group">
							<input class="input--style-2" type="text"
								placeholder="연락처(010-1234-5678)" name="phoneNum">
						</div>

						<div class="p-t-30">
							<button class="btn btn--radius btn--green" type="submit">수정</button>
							&nbsp; <a class="btn btn--radius btn--green" href="index">취소</a><br>
							<br> <a href="godropout" class="grey">회원탈퇴</a>
						</div>
					</form>
				</div>
			</div>
