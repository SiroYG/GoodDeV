				...
				<div class="card-body">
					...
					<form action="loginform" method="POST" id="loginform">
						...
						<div class="p-t-30">
							...
							<a class="btn btn--radius btn--green" href="/cloud/member/home">취소</a><br>
							<br> <a href="/cloud/member/gosign" class="grey">회원가입</a> <br>
							<br> <a href="/cloud/member/gofindid" class="grey">아이디 /
							</a> <a href="/cloud/member/gofindpw" class="grey">비밀번호 찾기</a>
