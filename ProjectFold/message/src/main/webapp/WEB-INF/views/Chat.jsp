...
<link rel="stylesheet" type="text/css"
	href="/message/resources/css/bootstrap-grid.css">
<link rel="stylesheet" type="text/css"
	href="/message/resources/css/bootstrap-reboot.css">
<link rel="stylesheet" type="text/css"
	href="/message/resources/css/bootstrap.css">
<link rel="stylesheet" type="text/css"
	href="/message/resources/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css"
	href="/message/resources/css/page.css">
<link rel="stylesheet"
	href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css"
	href="/message/resources/css/style.css">
<script type="text/javascript"
	src="/message/resources/js/jquery-3.4.1.min.js"></script>
<script type="text/javascript"
	src="/message/resources/js/sockjs.min.js"></script>
...
<c:set var="profile" value='<%=session.getAttribute("login")%>' />
 	...
 	<div class="col-12 row justify-content-center align-items-center my-5 ">
		<a href=""><img src="/message/resources/image/logo.png"
	...
	<div class="col-12" style="margin-top: 40px; clear: both;">
		<div class="col-10"
			...
			Chat Programaaaaaaaa <br>aaaaaaaaaaaaaaaaaaaaaaaaa
		</div>
