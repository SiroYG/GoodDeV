	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="index.html#practice-section" class="nav-link"><span>Q & A 게시판</span></a></li>
	          <li class="nav-item"><a href="index.html#attorneys-section" class="nav-link"><span>블라인드 테스트</span></a></li>
