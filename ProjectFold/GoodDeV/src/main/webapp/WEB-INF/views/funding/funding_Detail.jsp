        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="home">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="#">크라우드 펀딩 <i class="ion-ios-arrow-forward"></i></a></span> <span>펀딩 상세페이지 <i class="ion-ios-arrow-forward"></i></span></p>
                </div>
            </div>
        </div>
    </section>
...
<br>
                                       <!-- <p class="lead">현재 진행 금액 : (itemCurrencyPrice)</p>-->
                                        ...
                                        <hr>
                                        <button class="btns btn-3-green" type="button" data-toggle="modal" data-target="#exampleModal">결제하기
                                        </button>
                                    </div>
                                    <!--Content-->
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="nav-tab-card">
                                ...
                                <form action="" method="post" id="" role="form" class="needs-validation">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                <label><span class="hidden-xs">유효 기한</span> </label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="MM" name="" required>
                                                    <input type="text" class="form-control" placeholder="YY" name="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <button class="subscribe btn btn-submit btn-block" type="submit"> 결제하기 </button>
                                </form>
                            </div> <!-- tab-pane.// -->
                            <div class="tab-pane fade" id="nav-tab-bank">
                                <p>무통장입금을 원하실 경우 다음 계좌를 참고하세요.<br>
                ...
                <div class="modal-footer">
                    <!--<button type="button" class="btn btn-outline-info">결제하기</button>-->
        ...
        <div class="row mb-5">
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>특허 검색</a></li>
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>특허의 종류</a></li>
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>특허 등록</a></li>
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>특허 사용 허가</a></li>
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>필요 서류 관련</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
