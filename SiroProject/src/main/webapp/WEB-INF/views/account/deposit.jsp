...
<a href="/bank/goinfo">회원정보수정</a><a href="/bank/logout">로그아웃</a>&nbsp;&nbsp;&nbsp;			</div>
		...
		<div id="contents"><!--내용-->
			...
			<form id="depositForm" action="/bank/account/deposit" method="post">
			<ul class="basic_list">
				...
				<li><span>/ 입금금액</span><input class="wr_account" type="text" id="balance" name="balance"></li>
			</ul>
			</form>
			<p class="list_btn">
				<a href="/bank/account/haveaccountForm">이전</a><a class="select" href="javascript:depositClick();">입금</a>
			</p>
