			...
			<div class="login_area">
				...
				<form>
					<ul><!-- 회원가입 -->
						...
						<li class="grp_area"><label for="">회원구분</label><input type="radio" name="grp" checked /> 개인 <input type="radio" name="grp" /> 법인</li>
						<li><input type="text" placeholder="아이디" class="join_write" /><a href="#" class="id_check" onclick="window.open('Customer/join_pop','pop','resizable=no scrollbars=yes top=300 left=500 width=300 height=180');return false">중복체크</a></li>
						...
						<li><input type="text" placeholder="주민(사업자)번호" class="login_write" /></li>
						<li><input type="email" placeholder="이메일주소@도메인" class="login_write" /></li>
						<li><input type="text" placeholder="주소" class="login_write" /></li>
						<li><a href="login.html" class="btn_join">회원가입</a></li>
					</ul>
