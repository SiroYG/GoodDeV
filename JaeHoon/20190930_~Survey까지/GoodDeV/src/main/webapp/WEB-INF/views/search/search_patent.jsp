        ...
        tag += '<th scope="col">특허 보유자</th>'    
    	   ...
    	   $.each(res,function(i,item){
    	   	...
    	   	if(item.patentRegDate != null){
    	   		...
    	   		tag += '<td name=""><button type="button" class="btn btn-primary" data-number="${}" data-toggle="modal" data-target="#exampleModal">사용 허가 신청</button></td>'            
    	   		tag += '</tr>'        
    	   	})
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="memberId" id="appointment_name" placeholder="이름을 입력해주세요">
              </div>
              <div class="form-group">
                <label for="appointment_patentnum" class="text-black">특허번호</label>
                <input type="text" class="form-control" name="" id="appointment_patentnum" placeholder="KR000000000" readonly="readonly">
              </div>
               <div class="form-group">
