 ...
 * Generated at: 2019-10-07 13:28:32 UTC
...
public final class survey_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <head>\r\n");
      out.write("    <title>Survey :: Write Form</title>\r\n");
      ...
      out.write("    \t\r\n");
      out.write("    \t\r\n");
      out.write("//     \t$('#executeForm').on('click', function(){\r\n");
      out.write("    \t\t\r\n");
      out.write("// //     \t\tvar today = new Date(YYYY-MM-DD);\r\n");
      out.write("        \t\r\n");
      out.write("// //         \tvar result = format(today,'YYYY-MM-DD')\r\n");
      out.write("//     \t\talert(\"ok\")\r\n");
      out.write("//     \t\tvar a = $('#dueDate').val();\r\n");
      out.write("//     \t\talert(a)\r\n");
      out.write("//     \t\talert(\"result=\"+result)\r\n");
      out.write("    \t\t\r\n");
      out.write("//     \t\tif(result>=a){\r\n");
      out.write("//     \t\t\talert(\"마감일은 시작일로부터 하루 뒤이어야 합니다.\")\r\n");
      out.write("//     \t\t}\r\n");
      out.write("    \t\t\r\n");
      out.write("//     \t\tif($('#dueDate').val()==''){\r\n");
      out.write("//     \t\t\talert(\"마감일을 입력해주세요.\")\r\n");
      out.write("//     \t\t\treturn;\r\n");
      out.write("//     \t\t}\r\n");
      out.write("    \t\t\r\n");
      out.write("//     \t\tif($('#questionTitle').val().length==0||$('#questionTitle').val()==\"\"){\r\n");
      out.write("//     \t\t\talert(\"제목을 입력해주세요.\")\r\n");
      out.write("//     \t\t\treturn;\r\n");
      out.write("//     \t\t}\r\n");
      out.write("    \t\t\r\n");
      out.write("//     \t\tif($('#question').val().length==0||$('#question').val()==\"\"){\r\n");
      out.write("//     \t\t\talert(\"질문을 입력해주세요.\")\r\n");
      out.write("//     \t\t\treturn;\r\n");
      out.write("//     \t\t}\r\n");
      out.write("    \t\t\r\n");
      out.write("//     \t\t\t$('#goSurvey_list').submit();\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\t\r\n");
      out.write("    \t\t\r\n");
      ...
      out.write("    \r\n");
      out.write("    \r\n");
      out.write("    function executeForm(){\r\n");
      out.write("    \t\r\n");
      out.write("    \tif($('#dueDate').val()==''){\r\n");
      out.write("\t\t\talert(\"마감일을 입력해주세요.\")\r\n");
      out.write("\t\t\treturn;\r\n");
      ...
      out.write("    \tvar dueDate = $('#dueDate').val();\r\n");
      out.write("    \tvar tempDuedate=new Date(dueDate);\r\n");
      out.write("    \ttempDuedate.setHours(tempDuedate.getHours()-9);\r\n");
      out.write(" \t\r\n");
      out.write("\r\n");
      out.write("\t\t\r\n");
      out.write(" \t\tif(today.getTime()>tempDuedate.getTime()){\r\n");
      out.write(" \t\t\talert(\"마감일은 시작일로부터 하루 뒤이어야 합니다.\")\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\r\n");
      out.write(" \t\t}\r\n");
      ...
      out.write("        <form action=\"/cloud/survey/goSurvey_list\" method=\"POST\" id=\"goSurvey_list\">\r\n");
      out.write("        <input type=\"hidden\" name=\"itemNum\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${getOneItem.itemNum}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("            <div class=\"form-group row\">\r\n");
      out.write("                <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>시작일</b></span></label>\r\n");
      out.write("                <div class=\"col-sm-10\">\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" name=\"startDate\" id=\"startdate\" onchange=\"call()\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${times}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("                <div class=\"col-sm-10\">\r\n");
      out.write("                    <input type=\"date\" class=\"form-control\" name=\"dueDate\" id=\"enddate\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${times}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      ...
      out.write("            </div>\r\n");
      out.write("            <div class=\"form-group row\">\r\n");
      out.write("                <label for=\"inputPassword3\" class=\"col-sm-2 col-form-label\"><span><b>작성자</b></span></label>\r\n");
      out.write("                <div class=\"col-sm-10\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" name=\"memberId\" id=\"\" value=\"");
      ...
      out.write("                <div class=\"col-sm-10\">\r\n");
      out.write("                    <input type=\"text\" class=\"form-control\" name=\"questionTitle\" id=\"questionTitle\" placeholder=\"제목을 입력해주세요\">\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"form-group row\">\r\n");
      out.write("                <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>시제품 설명</b></span></label>\r\n");
      out.write("                <div class=\"col-sm-10\">\r\n");
      out.write("                    <textarea rows=\"8\" cols=\"112\" class=\"form-control\" name=\"itemContent\" id=\"itemContent\"  readonly=\"readonly\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${getOneItem.itemContent}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</textarea>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div class=\"form-group row\">\r\n");
      out.write("                <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>부가설명</b></span></label>\r\n");
      out.write("                <div class=\"col-sm-10\">\r\n");
      out.write("                    <textarea rows=\"8\" cols=\"112\" class=\"form-control\" name=\"description\" id=\"description\" placeholder=\"부가설명을 입력해주세요\"></textarea>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      ...
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                        <p class=\"form-control-readonly\">평가받고자 하는 항목을 자유롭게 기술해주세요.</p>\r\n");
      out.write("\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 1) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 2) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 3) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 4) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                       <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 5) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                        <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 6) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                       <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 7) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                       <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 8) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                       <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 9) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                       <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group row\">\r\n");
      out.write("                    <label for=\"\" class=\"col-sm-2 col-form-label\"><span><b>질문 10) </b></span></label>\r\n");
      out.write("                    <div class=\"col-sm-10\">\r\n");
      out.write("                       <input type=\"text\" class=\"form-control\" id=\"question\" name=\"question\" placeholder=\"질문을 입력해주세요\">\r\n");
      out.write("                        &nbsp; &nbsp; \r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("            <div class=\"form-group row\">\r\n");
      out.write("                <div class=\"col-sm-10\">\r\n");
      out.write("                    <a href=\"Javascript: executeForm();\" class=\"btns btn-3\" id=\"executeForm\"><span class=\"white\">&nbsp;&nbsp;작성하기&nbsp;&nbsp;</span></a> &nbsp;&nbsp; <a href=\"/cloud/survey/goSurvey_list\" class=\"btns btn-3-red\" style=\"margin-top: 0;\"><span class=\"white\">&nbsp;&nbsp;취소&nbsp;&nbsp;</span></a>\r\n");
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("            </div>\r\n");
      out.write("        </form>\r\n");
      ...
      out.write("                        <li><a href=\"#\"><span class=\"icon-long-arrow-right mr-2\"></span>소개글</a></li>\r\n");
      out.write("                        <li><a href=\"#\"><span class=\"icon-long-arrow-right mr-2\"></span>특허 FAQ</a></li>\r\n");
      out.write("                        <li><a href=\"#\"><span class=\"icon-long-arrow-right mr-2\"></span>설문조사</a></li>\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/survey/survey_form.jsp(136,20) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/survey/survey_form.jsp(152,20) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
