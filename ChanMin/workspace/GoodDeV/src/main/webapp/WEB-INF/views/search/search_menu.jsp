      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          ...
          <div class="alert alert-primary ftco-animate" role="alert">
                    특허 출원/사용 절차를 진행할 때는 지정된 서식을 사용해야 합니다. <a href="javascript:fn_downfile();" class="alert-link" id="saveDocumentFilename">서식 파일 다운로드</a>
                </div>
         <div class="boxes">
...
<div class="hr_div"></div>
  <a class="box2" href="/cloud/item/searchItem">
    ...
    <div class="boxes">
                    <a class="box2" href="#" data-toggle="modal" data-target="#exampleModal">
                        <h3>특허 출원 신청하기</h3>
...
시행일 : 본 약관은 2013년 4월 1일부터 시행된다.
                        ...
                        <div class="form-group">
                           ...
                           <%--  <input type="hidden" name="patentNum" value="${num}" > --%>
                            <input type="text" class="form-control" id="memName" value="${sessionScope.loginName}" name="patentHolderName" readonly="readonly" />
                        </div>
                        <!--  <div class="form-group">
