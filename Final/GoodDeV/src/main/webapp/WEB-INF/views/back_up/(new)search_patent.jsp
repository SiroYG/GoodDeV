        ...
        <div class="container">
           ...
           <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="goPatent" class="nav-link"><span>검색</span></a></li>
	          ...
	          <li style="margin-left: 20px; " class="nav-item cta"><a onclick="loginGo()" class="nav-link" data-toggle="modal" style="text-decoration: none;">로그인</a></li>
              <li style="margin-left: 20px;" class="nav-item cta"><a onclick="signGo()" class="nav-link" data-toggle="modal" style="text-decoration: none;">회원가입</a></li>
			  </c:if>	    
			  <c:if test="${sessionScope.loginId!=null}">
	          <li class="nav-item"><a href="/cloud/member/goMypage" class="nav-link"><span>마이페이지</span></a></li>
			  <li style="margin-left: 20px;" class="nav-item cta"><a class="nav-link" href="/cloud/member/logout">${sessionScope.loginName} ${sessionScope.loginType}님, 로그아웃 </a></li>
