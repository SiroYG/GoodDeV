...
<head>
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#practice-section" class="nav-link"><span>특허 FAQ</span></a></li>
	          <li class="nav-item"><a href="#blog-section" class="nav-link"><span>크라우드 펀딩</span></a></li>
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('/cloud/resources/images/bg_1.jpg');" data-section="home">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p><a href="#" class="btn btn-primary py-3 px-4">특허 검색하기</a></p>
          </div>
        </div>
      </div>
    </section>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex order-md-last">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(/cloud/resources/images/about.jpg);">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(/cloud/resources/images/about-1.jpg);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-6 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate pb-5">
		            ...
		            <h2 class="mb-4" style="font-size: 44px; text-transform: capitalize;">실제 특허 출원 사례 모음</h2>
		          </div>
		          <div class="col-md-12 testimony-section">
								<div class="owl-carousel carousel-testimony">
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(/cloud/resources/images/person_1.jpg);"></div>
				          			<div>
			                    ...
			                    <span class="position">Businessman</span>
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(/cloud/resources/images/person_2.jpg);"></div>
				          			<div>
				          				<p class="name mb-0">Luis Fox</p>
			                    <span class="position">Businessman</span>
				          			</div>
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(/cloud/resources/images/person_3.jpg);"></div>
				          			<div>
				          				<p class="name mb-0">Luis Fox</p>
			                    <span class="position">Businessman</span>
				          			</div>
        ...
        <div class="row no-gutters">
          <div class="col-md-5 col-lg-3 ftco-animate py-4 nav-link-wrap">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link px-4 py-1" id="v-pills-6-tab" data-toggle="pill" href="#v-pills-6" role="tab" aria-controls="v-pills-6" aria-selected="false"><span class="mr-3 flaticon-idea"></span> 특허 절차 관련 수수료</a>

              <a class="nav-link px-4 py-1" id="v-pills-8-tab" data-toggle="pill" href="#v-pills-8" role="tab" aria-controls="v-pills-8" aria-selected="false"><span class="mr-3 flaticon-idea"></span> 필요 서류 관련</a>
              ...
              <div class="tab-pane fade show active py-0 py-lg-5" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
              	<div class="d-lg-flex">
		              ...
		              <div class="text">
		                ...
		                <p><a href="#" class="btn btn-primary px-4 py-3">검색하기</a></p>
	                </div>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="#" class="block-20" style="background-image: url('/cloud/resources/images/image_1.jpg');">
              </a>
